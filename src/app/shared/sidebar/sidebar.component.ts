...
export class SidebarComponent implements OnInit {
  ...
  ngOnInit(): void {
    for (let i = 0; i < this.permissions.data.user.sections.length; i++) {
      ...
      if(this.permissions.data.user.sections[i] == 'الطلبات-جاري التواصل مع المورد'){
        this.orders2 = 1
      }
      if(this.permissions.data.user.sections[i] == 'الطلبات-شحنات تحت المراجعة'){
        this.orders3 = 1
      }
      if(this.permissions.data.user.sections[i] == 'الطلبات-الطلبات المعلقة'){
        this.orders4 = 1
      }
      if(this.permissions.data.user.sections[i] == 'الطلبات-جاري شحنها من الصين'){
        this.orders5 = 1
      }
      if(this.permissions.data.user.sections[i] == 'الطلبات-شحنات في ميناء المملكة تحت المراجعة الجمركية'){
        this.orders6 = 1
      }
      if(this.permissions.data.user.sections[i] == 'الطلبات-شحنات جاري تفريغها في مستودعاتنا'){
        this.orders7 = 1
      }
      if(this.permissions.data.user.sections[i] == 'الطلبات-شحنات جاري توصيلها للعميل'){
        this.orders8 = 1
      }
